...
describe("AccountCard Component", () => {
  ...
  describe("rendering", () => {
    ...
    it("doit afficher 'Unranked' si pas de rang", () => {
      const accountNoRank = {
        ...mockAccount,
        stats: { rankIcon: "", lastUpdate: Date.now() },
      };
    ...
    it("ne doit pas afficher les stats si pas de riotId", () => {
      const accountNoRiotId = {
        ...mockAccount,
        riotId: undefined as unknown as string,
      };
  ...
  describe("card image", () => {
    ...
    it("doit convertir le chemin local en protocole sm-img", () => {
      const accountWithLocalImage = {
        ...mockAccount,
        cardImage: "C:\\Users\\test\\image.png",
      };
  ...
  describe("active state", () => {
    ...
    it("doit garder le bouton actif cliquable si isActive (reconnexion)", () => {
      ...
      expect(onReconnect).toHaveBeenCalledWith(mockAccount);
    });
  });
