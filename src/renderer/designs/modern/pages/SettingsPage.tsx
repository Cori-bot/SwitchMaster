      ...
      <section className="section">
        ...
        <div className="setting">
          ...
          <div className="theme-cards" style={{ maxWidth: "400px" }}>
            <div
              className={`theme-card ${(config.activeDesignModule || "classic") === "modern" ? "active" : ""}`}
              onClick={() => onUpdateConfig({ activeDesignModule: "modern" })}
            >
              <h4>Modern</h4>
            </div>
            <div
              className={`theme-card ${(config.activeDesignModule || "classic") === "classic" ? "active" : ""}`}
              onClick={() => onUpdateConfig({ activeDesignModule: "classic" })}
            >
              <h4>Classic</h4>
            </div>
            <div
              className={`theme-card ${config.activeDesignModule === "pro" ? "active" : ""}`}
              onClick={() => onUpdateConfig({ activeDesignModule: "pro" })}
            >
              <h4>Pro</h4>
            </div>
          </div>
